clear all;
close all;
%load('dropout/sae-1-0.001-ci-tst.mat');
% load('dropout/sae-1-0.001-ci-trn.mat');
 load('dropout/sae-1-0.0001-ci-tst.mat');
% load('dropout/sae-1-0.0001-ci-trn.mat');
hlines(1) = plot(1:300, cindex_test);
set(hlines(1), 'color', [51/255 0 0]);
hold on

%load('dropout/sae-2-0.001-ci-tst.mat');
% load('dropout/sae-2-0.001-ci-trn.mat');
 load('dropout/sae-2-0.0001-ci-tst.mat');
% load('dropout/sae-2-0.0001-ci-trn.mat');
